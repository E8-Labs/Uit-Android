...
public class ProfileDemoGraphicInfoModel implements Parcelable {
    ...
    public ProfileDemoGraphicInfoModel(int id, List<NameIdModel> racesList, int gender, int lgbt, int veteran, int user_id) {
        this.id = id;
    ...
    protected ProfileDemoGraphicInfoModel(Parcel in) {
        ...
        this.veteran = in.readInt();
        this.user_id = in.readInt();
    }

    public static final Parcelable.Creator<ProfileDemoGraphicInfoModel> CREATOR = new Parcelable.Creator<ProfileDemoGraphicInfoModel>() {
        @Override
