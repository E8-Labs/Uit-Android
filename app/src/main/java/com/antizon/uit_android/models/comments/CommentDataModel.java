...
public class CommentDataModel implements Parcelable {
    ...
    public CommentDataModel(int id, String comment, int reply_to, String mention_to, int post_id, int user_id, UitUserModel userModel, String created_at, int comments, int likes, boolean isLiked) {
        this.id = id;
    ...
    public static final Parcelable.Creator<CommentDataModel> CREATOR = new Parcelable.Creator<CommentDataModel>() {
        @Override
