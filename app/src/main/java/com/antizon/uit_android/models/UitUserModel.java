...
public class UitUserModel implements Parcelable {
    @SerializedName("id")
    private int id;
    @SerializedName("name")
    private String name;
    ...
    public UitUserModel(int id, String name, int role, String profile_image, String job_title, int user_id, String greenhouse_access_token) {
        this.id = id;
        this.name = name;
        this.role = role;
    ...
    protected UitUserModel(Parcel in) {
        this.id = in.readInt();
    ...
    public static final Creator<UitUserModel> CREATOR = new Creator<UitUserModel>() {
        @Override
        public UitUserModel createFromParcel(Parcel source) {
            return new UitUserModel(source);
        }

        @Override
        public UitUserModel[] newArray(int size) {
            return new UitUserModel[size];
        }
    };
}
