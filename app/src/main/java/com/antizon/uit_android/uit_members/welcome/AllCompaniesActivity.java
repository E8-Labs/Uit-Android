...
public class AllCompaniesActivity extends BaseActivity {
    ...
    private static final String TAG = AllCompaniesActivity.class.getSimpleName();
    ProgressDialog progressDialog;
    SessionManagement sessionManagement;
    ImageView profilePicture;
    TextView pending, approved;
    ConstraintLayout pendingLayout, approvedLayout, pausedLayout;
    RecyclerView pendingCompaniesRecyclerview, approvedCompaniesRecyclerview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilities.setCustomStatusAndNavColor(AllCompaniesActivity.this, R.color.white_dash, R.color.white_dash);
        setIds();
        initialize();
        setListener();
    ...
    void initialize() {
        ...
        progressDialog = new ProgressDialog(AllCompaniesActivity.this);
        pendingList = new ArrayList<>();
        approvedList = new ArrayList<>();
        sessionManagement = new SessionManagement(AllCompaniesActivity.this);
        accessToken = sessionManagement.getToken();


        loadProfile(AllCompaniesActivity.this, sessionManagement.getProfileImage(), profilePicture);
    }
    ...
    void setUpUitAdminPendingRecyclerview() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(AllCompaniesActivity.this);
        pendingCompaniesRecyclerview.setLayoutManager(linearLayoutManager);

        pendingAdapter = new UitAdminPendingAdapter(pendingList, AllCompaniesActivity.this,
    ...
    void setUpUitAdminApprovedRecyclerview() {
        ...
        approvedAdapter = new UitAdminApprovedAdapter(approvedList, AllCompaniesActivity.this);
    ...
    void getUitAdminPending(String search) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AllCompaniesActivity.this);
