...
public class ApplicantValueProp extends BaseActivity {
    private static final String TAG = ApplicantValueProp.class.getSimpleName();
    ...
    void setNextLayout() {
        ...
        if (currentlyViewedLayout == 1) {
            ...
            Intent intent = new Intent(ApplicantValueProp.this, ApplicantPersonalInfoActivity.class);
