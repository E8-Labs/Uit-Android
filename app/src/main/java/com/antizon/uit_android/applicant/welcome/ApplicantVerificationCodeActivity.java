...
public class ApplicantVerificationCodeActivity extends BaseActivity {
    Context context;
    private static final String TAG = ApplicantVerificationCodeActivity.class.getSimpleName();
    ...
    void initialize() {
        ...
        sessionManagement = new SessionManagement(ApplicantVerificationCodeActivity.this);
