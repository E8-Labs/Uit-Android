...
public class ApplicantSelectDepartmentActivity extends AppCompatActivity implements ApplicantSelectDegreeAdapter.ApplicantSelectDegreeAdapterCallBack {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_applicant_select_department);
        Utilities.setCustomStatusAndNavColor(ApplicantSelectDepartmentActivity.this, R.color.white_dash, R.color.white_dash);
        context = ApplicantSelectDepartmentActivity.this;
        service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService.class);
        progressDialog = new ProgressDialog(ApplicantSelectDepartmentActivity.this);
    ...
    private void requestForGetDegreesList() {
        Call<ApplicantDegreesListResponseModel> call = service.getSelectWorkExperienceDepartmentList();
