...
public class CompanyValueProp extends BaseActivity {
    private static final String TAG = CompanyValueProp.class.getSimpleName();
    ...
    void setListener() {
        ...
        getStarted.setOnClickListener(v -> {
            Intent intent = new Intent(CompanyValueProp.this, UploadCompanyLogoActivity.class);
