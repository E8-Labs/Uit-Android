...
public class Lead extends BaseActivity {
    ...
    String selectedStageId = "", selectedStageName = "", typeHereValue = "", companyNameHintValue = "",
            encodedImageData = "", sizeValue = "", headquarterValue = "", websiteValue, emailValue = "",
            verificationValue = "", passwordValue = "", deiStatementValue = "", leadValue = "";
    ...
    void initialize() {
        ...
        loadProfile(Lead.this, encodedImageData, redNoah);
    ...
    void openNextScreen() {
        ...
        Intent intent = new Intent(Lead.this, ERG.class);
