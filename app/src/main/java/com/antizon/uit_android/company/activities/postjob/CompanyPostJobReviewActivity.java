...
public class CompanyPostJobReviewActivity extends AppCompatActivity implements CompanyPostJobExperienceAdapter.CompanyPostJobExperienceAdapterCallBack {
    ...
    String jobTitle, jobLocation, jobRole, jobResponsibilities, applicationDeadLineDate = "";
    ...
    private void getIntentData(){
        if (getIntent() !=null){
            ...
            minSalary = getIntent().getIntExtra("maxSalary", 0);
    ...
    private void requestForAddJob() {
        ...
        mainObject.addProperty("city", jobLocation);
        ...
        mainObject.addProperty("max_salary", 100000);
        mainObject.addProperty("min_salary", 50000);
        ...
        mainObject.addProperty("state", jobLocation);
        if (isVaccinationRequired){
