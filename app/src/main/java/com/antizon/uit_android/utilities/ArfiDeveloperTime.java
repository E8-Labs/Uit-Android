...
public class ArfiDeveloperTime {
    ...
    public String getPrettyTime(String time, String pattern) {
        if (TextUtils.isEmpty(time)) return time;

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
        try {
            Date date = simpleDateFormat.parse(time);
            return date == null ? time : getPrettyTime(date.getTime());
    ...
    public String getPrettyTime(long milliseconds) {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy-hh:mm a", Locale.UK);
        String currentDate = dateFormat.format(new Date(currentTime));
        ...
        if (timeDiff >= 31556926000L) {
            String output = (timeDiff / 31556926000L) + " years ago";
            return output;
        } else if (timeDiff >= 2629743000L) {
            String output2 = (timeDiff / 2629743000L) + " months ago";
            return output2;
        } else if (timeDiff >= 86400000) {
            if (timeDiff < 604800000) {
                String output3 = (timeDiff / 86400000) + " days ago";
                return output3;
            }
            String output4 = (timeDiff / 604800000) + " weeks ago";
            return output4;
        } else if (timeDiff >= 3600000) {
            int hours = (int) (timeDiff / 3600000);
            String output5 = hours + " hours ago";
            return output5;
        } else if (timeDiff >= 60000) {
            int mins = (int) (timeDiff / 60000);
            String output6 = mins + " minutes ago";
            return output6;
        } else {
            ...
            String output7 = seconds + " seconds ago";
            return output7;
        }
    }
