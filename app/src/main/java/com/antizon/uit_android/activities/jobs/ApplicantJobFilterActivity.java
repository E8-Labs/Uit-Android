...
public class ApplicantJobFilterActivity extends AppCompatActivity {
    ...
    List<IndustryModel> tags;
    List<MultiSelectionModel> employmentList;
    ...
    private void moveToNext() {
        ...
        String industryIdsString = Utilities.getCommaSeparatedString(industryIds);
        ...
        intent.putExtra("industries", industryIdsString);//comma separated ids of industries
        intent.putExtra("title", jobTitle); // string
        intent.putExtra("location", location); // string
        intent.putExtra("lat", latitude);// double
        intent.putExtra("lng", longitude);// double
        intent.putExtra("employment", employmentIdsString);//comma separated ids of selected employment types
