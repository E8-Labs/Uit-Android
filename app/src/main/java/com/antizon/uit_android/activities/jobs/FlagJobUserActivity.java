...
public class FlagJobUserActivity extends AppCompatActivity {
    ...
    String type, jobTitle, flagId;
    GenericUserDataModel flagDataModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flagDataModel = getIntent().getParcelableExtra("flagDataModel");
        ...
        if (type.equals("flag_job")){
            ...
            flagId = getIntent().getStringExtra("jobId");
            text_profileName.setText(jobTitle);
        }else {
            flagId = String.valueOf(flagDataModel.getUser_id());
            text_profileName.setText(flagDataModel.getName());
        }
        Utilities.loadImage(context, flagDataModel.getProfile_image(), profileImageView);
