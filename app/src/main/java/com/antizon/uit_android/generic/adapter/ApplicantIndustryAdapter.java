...
public class ApplicantIndustryAdapter extends RecyclerView.Adapter<ApplicantIndustryAdapter.MyViewHolder> {

    private static final String TAG = ApplicantIndustryAdapter.class.getSimpleName();
  ...
  SelectionListener selectionListener;
    ...
    public ApplicantIndustryAdapter(List<ModelCompanySize> list, Context context  , SelectionListener selectionListener ) {
    ...
    @NonNull
    @Override
    public ApplicantIndustryAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_company_industry, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ApplicantIndustryAdapter.MyViewHolder holder, final int position) {
