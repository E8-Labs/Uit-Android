...
public class UitAdminPendingAdapter extends RecyclerView.Adapter<UitAdminPendingAdapter.MyViewHolder> {

    //    private static final String TAG = UitAdminPendingAdapter.class.getSimpleName();
    private static final String TAG = "PendingCompanies: UitAdminPendingAdapter";

    List<ModelUitAdminPending> list;
    Context context;
    CompanyStatusInterface companyStatusInterface;

    public UitAdminPendingAdapter(List<ModelUitAdminPending> list, Context context, CompanyStatusInterface companyStatusInterface) {
        this.list = list;
    ...
    @NonNull
    @Override
    public UitAdminPendingAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pending, parent, false);
        Log.d(TAG, "onCreateViewHolder: ");
        return new UitAdminPendingAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final UitAdminPendingAdapter.MyViewHolder holder, final int position) {
        Log.d(TAG, "onBindViewHolder: ");
        final ModelUitAdminPending dataModel = list.get(getItemViewType(position));
