...
import com.antizon.uit_android.uit_admin.welcome.MemberDetail;
...
public class UitMemberDetailAdapter extends RecyclerView.Adapter<UitMemberDetailAdapter.MyViewHolder> {

    private static final String TAG = "PendingCompanies: UitMemberDetailAdapter";

    List<ModelAdminApplicants> list;
    Context context;
    ArrayList<ModelAdminApplicants> filterArrayList = new ArrayList<>();

    UitMemberDetailAdapterCallBack callBack;


    public UitMemberDetailAdapter(Context context, List<ModelAdminApplicants> list, UitMemberDetailAdapterCallBack callBack) {
    ...
    @NonNull
    @Override
    public UitMemberDetailAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_all_members, parent, false);
        Log.d(TAG, "onCreateViewHolder: ");
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final UitMemberDetailAdapter.MyViewHolder holder, final int position) {
...
//        Log.d(TAG, "onBindViewHolder: active_members: " + dataModel.getActive_members());
        ...
        holder.softwareDeveloper.setText("Senior Job Manager");
        Glide.with(context)
        ...
        holder.adminMemberLayout.setOnClickListener(view -> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ConstraintLayout adminMemberLayout;
        ...
        public MyViewHolder(View itemView) {
            ...
            adminMemberLayout = itemView.findViewById(R.id.adminMemberLayout);
        }
    }
    ...
    public interface UitMemberDetailAdapterCallBack{
