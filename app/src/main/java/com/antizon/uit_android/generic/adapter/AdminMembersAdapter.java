...
public class AdminMembersAdapter extends RecyclerView.Adapter<AdminMembersAdapter.MyViewHolder> {

    private static final String TAG = "PendingCompanies: AdminMembersAdapter";
    ...
    public AdminMembersAdapter(List<ModelAdminApplicants> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdminMembersAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_all_members, parent, false);
        Log.d(TAG, "onCreateViewHolder: ");
        return new AdminMembersAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdminMembersAdapter.MyViewHolder holder, final int position) {
...
//        Log.d(TAG, "onBindViewHolder: active_members: " + dataModel.getActive_members());
        ...
        holder.adminMemberLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
