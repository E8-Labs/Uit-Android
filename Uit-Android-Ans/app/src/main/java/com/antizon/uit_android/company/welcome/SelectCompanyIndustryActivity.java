...
public class SelectCompanyIndustryActivity extends AppCompatActivity implements ApplicantSelectDegreeAdapter.ApplicantSelectDegreeAdapterCallBack {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilities.setCustomStatusAndNavColor(SelectCompanyIndustryActivity.this, R.color.white_dash, R.color.white_dash);
        context = SelectCompanyIndustryActivity.this;
        service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService.class);
        progressDialog = new ProgressDialog(SelectCompanyIndustryActivity.this);
        ...
        progressDialog.show();
        requestForGetCompanyIndustries();
    }

    private void requestForGetCompanyIndustries() {
        Call<ApplicantDegreesListResponseModel> call = service.getCompanyIndustriesList();
                ...
                if (response.isSuccessful()) {
                    if (response.body()!=null){
                        if (response.body().isStatus()){
                            ...
                            setDegreesToRecyclerView(recyclerview_industry, degreesList);
                        }else {
