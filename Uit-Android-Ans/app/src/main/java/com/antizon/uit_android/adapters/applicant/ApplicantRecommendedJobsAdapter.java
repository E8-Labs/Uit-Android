...
public class ApplicantRecommendedJobsAdapter extends RecyclerView.Adapter<ApplicantRecommendedJobsAdapter.ViewHolder> {

    Context context;
    List<ApplicantHomeJobDataModel> recommendedJobsList;

    public ApplicantRecommendedJobsAdapter(Context context, List<ApplicantHomeJobDataModel> recommendedJobsList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_recommended_job, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ApplicantHomeJobDataModel featuredJobModel = recommendedJobsList.get(position );
    ...
    public int getItemCount() {
        return recommendedJobsList.size();
    }
