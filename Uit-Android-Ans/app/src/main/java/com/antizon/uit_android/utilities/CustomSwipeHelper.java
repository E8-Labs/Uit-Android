...
public abstract class CustomSwipeHelper extends ItemTouchHelper.SimpleCallback  {
    ...
    public CustomSwipeHelper(Context context, RecyclerView recyclerView) {
    ...
    public static class UnderlayButton {
        ...
        public void onDraw(Canvas c, RectF rect, int pos){
            ...
            if(imageResId == 0){
                ...
                Bitmap bitmap = drawableToBitmapFn(d);
                c.drawBitmap(bitmap ,(rect.left+20+rect.right-100)/2 , (rect.top-70+rect.bottom)/2,p);
            }
        ...
        private Bitmap drawableToBitmapFn(Drawable d) {
    ...
    public void setViewSwipeEnabled(boolean mSwipeAble){
